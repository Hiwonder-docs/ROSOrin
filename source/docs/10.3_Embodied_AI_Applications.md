...
Before enabling this feature, a map must be created in advance. Please refer to [5.1 Mapping Tutorial](5_Mapping_%26_Navigation_Course.html#mapping-tutorial) for detailed instructions on how to build the map.
