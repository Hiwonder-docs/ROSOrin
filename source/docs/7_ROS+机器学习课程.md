...
Power on the robot and connect it via the NoMachine remote control software. For detailed information, please refer to the section [7.2 AP Mode Connection Steps](1.ROSOrin使用手册.md#AP-Mode-Connection-Steps) in the user manual.
...
#### 7.3.3.2 YOLOv5 Model Structure
...
To facilitate understanding, output structure diagrams for each of the three sizes are provided below:

<img src="../_static/media/chapter_10/section_1/media/image22.png"   style="width:600px"  class="common_img" />

<img src="../_static/media/chapter_10/section_1/media/image23.png"   style="width:600px"  class="common_img" />

<img src="../_static/media/chapter_10/section_1/media/image24.png"   style="width:600px"  class="common_img" />

### 7.3.4 YOLOv5 Workflow
...
8. After selecting the target directory, click **Open**.
...
<img src="../_static/media/chapter_10/section_1/media/image56.png"  style="width:300px"  class="common_img" />
...
Before starting this section, make sure you have completed image collection and annotation. For detailed steps, refer to section **7.3.5 Image Collection and Annotation**.
...
The items listed after the names represent the types of labels. The `nc` field specifies the total number of label categories. The `train` refers to the training set—a commonly used term in deep learning that indicates the data used for model training. The parameter following it is the path to the training images. Similarly, the `val` refers to the validation set, which is used to verify the model’s performance during the training process, and the path that follows indicates where the validation data is located. These file paths need to be set based on the actual location of your data. For example, if you plan to speed up the training process later by moving the dataset from the robot to a local PC or a cloud server, you'll need to update the train and val paths accordingly to reflect their new locations.
...
After converting the dataset format, you can proceed to the model training phase. Before starting, make sure the dataset with the correct format is ready. For details, refer to section [7.3.6 Data Format Conversion](#anther7.3.6).
...
Next, follow the instructions in [7.3.8 TensorRT Inference Acceleration](#anther7.3.8) for model conversion and testing.
...
3. Then enter the command to navigate to the specific directory.

```bash
cd ~/third_party_ros2/yolov5/
```

4. Then, run the following command to convert the **.pt** file to a **.wts** file:
...
**The conversion is successful when the image below appears, as indicated by the red box.**

<img src="../_static/media/chapter_10/section_1/media/image73.png"  style="width:600px"  class="common_img" />

5. Next, execute the command to navigate to the specified directory.

```bash
cd ~/third_party_ros2/tensorrtx/yolov5/
```

6. Then, enter the command to open the designated file.

```
gedit src/config.h
```

7. Locate the `kNumClass` parameter in the code shown in the image below. This parameter represents the number of object categories for detection. Modify the value according to the actual number of categories, and adjust the categories to match the labeled classes.

<img src="../_static/media/chapter_10/section_1/media/image76.png"  style="width:600px"  class="common_img" />

8. After making the necessary modifications, press **Ctrl+S** to save and exit the editor.

9. Next, in the current terminal, enter the following command to navigate to the newly created build directory:

```bash
mkdir build && cd build
```

10. Then, compile the build folder by entering the command:

```
cmake ..
```

<img src="../_static/media/chapter_10/section_1/media/image78.png"  style="width:600px"  class="common_img" />

11. Enter the command to compile the configuration file.

```bash
make
```

Once the following message appears, it indicates that the build process has completed successfully.

<img src="../_static/media/chapter_10/section_1/media/image80.png"  style="width:600px"  class="common_img" />

Input the command to copy the generated **best.wts** file to the current directory.
...
In the same directory, a **libmyplugins.so** file will also be created for future detection tasks. When the **libmyplugins.so** file needs to be used, simply specify the path to the file.
...
<img src="../_static/media/chapter_10/section_1/media/image84.jpeg"   style="width:200px"  class="common_img" />
 ...
 Open a terminal in the current directory and enter the command to add read permissions.
...
1. In the previous terminal, enter the command to copy the TensorRT model engine file to the designated folder, then press **Enter**.
...
3. Click <img src="../_static/media/chapter_10/section_1/media/image88.png" /> to open the file manager and navigate to the folder shown below.
...
<img src="../_static/media/chapter_10/section_1/media/image90.png"  style="width:600px"  class="common_img" />
...
<img src="../_static/media/chapter_10/section_1/media/image91.png"  style="width:600px"  class="common_img" />

6. Click **Save** at the top-right corner to save the changes.

<img src="../_static/media/chapter_10/section_1/media/image92.png"  style="width:600px"  class="common_img" />

7. Finally, enter the command to start object detection.
...
Place a traffic sign within the camera’s field of view. Once the sign is detected, a bounding box will appear in the camera feed, highlighting the sign along with its class name and detection confidence. Additionally, the terminal will print related detection information.
...
6. Use the shortcut **Ctrl+U**, set the image storage directory to **/home/ubuntu/my_data/JPEGImages/**, and click **Open**.

<img src="../_static/media/chapter_10/section_1/media/image106.png"  style="width:600px"  class="common_img" />

7. Use the shortcut **Ctrl+R**, set the annotation data storage directory to **/home/ubuntu/my_data/Annotations/**, and click **Open**. The **Annotations** folder will be automatically generated when collecting images.
...
<img src="../_static/media/chapter_10/section_1/media/image109.png"  style="width:300px"  class="common_img" />
...
12. Click the icon <img src="../_static/media/chapter_10/section_1/media/image110.png" /> in the system status bar to open the file manager and navigate to the directory **/home/ubuntu/my_data/Annotations/** to view the image annotation files. This is the same dataset path where the images were saved during data collection.
...
<img src="../_static/media/chapter_10/section_1/media/image115.png"  style="width:600px"  class="common_img" />
...
<img src="../_static/media/chapter_10/section_1/media/image118.png"  style="width:600px"  class="common_img" />

<img src="../_static/media/chapter_10/section_1/media/image119.png"  style="width:600px"  class="common_img" />
...
3. Copy the model file **best.pt** generated after training to the current directory.

```bash
cp ~/third_party_ros2/yolov5/runs/train/exp5/weights/best.pt ./
```
...
5. Then enter the command to navigate to the specific directory.
...
9. Enter the command to navigate into the newly created build directory.

```bash
cd ~/third_party_ros2/tensorrtx/yolov5/ && mkdir build && cd build
```
...
```bash
sudo systemctl stop start\_app\_node.service
```

2. Click <img src="../_static/media/chapter_10/section_1/media/image88.png" /> to open the file manager and navigate to the folder shown below.

<img src="../_static/media/chapter_10/section_1/media/image89.png"  style="width:600px"  class="common_img" />

3. Right-click the file **yolov5_trt.py** and select **Open With Text Editor**.

<img src="../_static/media/chapter_10/section_1/media/image90.png"  style="width:600px"  class="common_img" />

4. In the first red box, delete the existing content and enter the names of the objects to be recognized. In the second red box, enter the name of the trained model in the first parameter. In the second parameter, enter **libmyplugins_640.so**, ensuring to rename the original **libmyplugins.so** file based on your specific file name.

<img src="../_static/media/chapter_10/section_1/media/image91.png"  style="width:600px"  class="common_img" />

5. Click **Save** at the top-right corner to save the changes.

<img src="../_static/media/chapter_10/section_1/media/image92.png"  style="width:600px"  class="common_img" />

6. Finally, enter the command to start object detection.

```bash
python3 ~/ros2_ws/src/example/example/yolov5_detect/yolov5_trt.py 
```

7. After making the modifications, follow the section **Autonomous Driving** in this document to experience the feature.

### 7.3.10 Model Training for Waste Card

**The product names and reference paths mentioned in this document may vary. Please refer to the actual setup for accurate information.**

It is not recommended to use the Jetson Orin Nano for training with large datasets, as the training speed is slow due to I/O speed and memory limitations. Instead, it is advised to use a PC with a dedicated GPU, which follows the same training steps, only requiring proper environment configuration.

If the recognition performance of the waste sorting feature is unsatisfactory, and there is a need to train a custom model, refer to this section for guidance on training a custom model for the application.

#### 7.3.10.1 Preparation

1. Prepare a laptop, or if using a desktop, make sure to have a wireless network card, mouse, and other necessary tools.
2. Follow the previous steps to install and launch the NoMachine remote connection tool. 
...
6. Place the card to be trained within the camera's field of view, and click **Save** to capture the current frame. Ensure that the number of images for each category is the same. For example, if 50 images of the banana peel card are captured, the toothbrush card should also have 50 images.

<img src="../_static/media/chapter_10/section_1/media/image126.png"  style="width:600px"  class="common_img" />
...
7. After collecting images, click the **Quit** button to close the tool.

<img src="../_static/media/chapter_10/section_1/media/image101.png"  style="width:600px"  class="common_img" />

8. Click on the icon <img src="../_static/media/chapter_10/section_1/media/image127.png" /> in the system status bar to open the file manager. Navigate to the directory as shown in the image below to view the saved images.
...
4. Finally, run the following command to launch the annotation software:
...
|----------|----------|----------|
| <img src="../_static/media/chapter_10\section_1/media/image42.png"    class="common_img" />| Ctrl+U| Choose the directory for images.|
| <img src="../_static/media/chapter_10\section_1/media/image43.png"   class="common_img" />| Ctrl+R| Choose the directory for calibration data.|
| <img src="../_static/media/chapter_10\section_1/media/image44.png"    class="common_img" />| W| Create an annotation box.|
| <img src="../_static/media/chapter_10\section_1/media/image45.png"  class="common_img" />| Ctrl+S| Save the annotation.|
| <img src="../_static/media/chapter_10\section_1/media/image46.png"    class="common_img" />| A| Switch to the previous image.|
| <img src="../_static/media/chapter_10\section_1/media/image47.png" class="common_img" />| D| Switch to the next image.|
...
<img src="../_static/media/chapter_10/section_1/media/image128.png"   style="width:600px"  class="common_img" />
...
<img src="../_static/media/chapter_10/section_1/media/image129.png"   style="width:600px"  class="common_img" />

8. Then, click on **Create RectBox** in the left toolbar to create a bounding box.

<img src="../_static/media/chapter_10/section_1/media/image130.png"  style="width:600px"  class="common_img" />

9. Position the mouse over the area to label, then press and hold the left mouse button to drag and draw a rectangle around the object in the image. For example, label the banana in the image.

<img src="../_static/media/chapter_10/section_1/media/image131.png"  style="width:600px"  class="common_img" />
...
<img src="../_static/media/chapter_10/section_1/media/image132.png"  style="width:600px"  class="common_img" />
...
<img src="../_static/media/chapter_10/section_1/media/image133.png"  style="width:600px"  class="common_img" />
...
3. Press the **i** key to enter edit mode and add the class names for the target recognition objects. When adding multiple class names, each class name should be placed on a new line. For multiple entries, press **Enter** to create a new line, and then proceed with listing the class names according to their respective categories.

<img src="../_static/media/chapter_10/section_1/media/image134.png"  style="width:600px"  class="common_img" />
...
<img src="../_static/media/chapter_10/section_1/media/image135.png"  style="width:600px"  class="common_img" />
...
In the command, `--img` specifies the image size, `--batch` indicates the number of images input per batch, and `--epochs` refers to the number of training iterations, representing how many times the machine learning model will go through the dataset. This value should be optimized based on the actual performance of the final model. In this example, the number of training epochs is set to 300 for quick testing. If the computer system is more powerful, this value can be increased to achieve better training results. `--data` is the path to the dataset, which refers to the folder containing the manually annotated data. `--weights` indicates the path to the pre-trained model weights. This specifies which .pt weight file the training process is based on. It’s important to note whether you are using yolov5n.pt, yolov5s.pt, or another version.
...
### 7.3.11 Model Training with Physical Objects
...
#### 7.3.11.1 Preparation

1. Prepare a laptop, or if using a desktop, make sure to have a wireless network card, mouse, and other necessary tools.

2. Follow the previous steps to install and launch the remote connection tool, NoMachine.

#### 7.3.11.2 Operation Steps
...
<img src="../_static/media/chapter_10/section_1/media/image137.png"  style="width:600px"  class="common_img" />
...
<img src="../_static/media/chapter_10/section_1/media/image138.png"  style="width:600px"  class="common_img" />
...
9. Click on the icon <img src="../_static/media/chapter_10/section_1/media/image110.png" /> in the system status bar to open the file manager. Navigate to the directory as shown in the image below to view the saved images.
...
6. First, click **Open Dir** to open the folder where the images are stored. Choose **/home/ubuntu/My_Data/JPEGImage** and click **Open** to access the folder.

<img src="../_static/media/chapter_10/section_1/media/image129.png"   style="width:600px"  class="common_img" />

7. Then, click on **Create RectBox** in the left toolbar to create a bounding box.

<img src="../_static/media/chapter_10/section_1/media/image139.png"  style="width:600px"  class="common_img" />

8. Position the mouse over the area to label, then press and hold the left mouse button to drag and draw a rectangle around the object in the image. Taking an apple as an example in this section.

<img src="../_static/media/chapter_10/section_1/media/image140.png"  style="width:600px"  class="common_img" />

9. After releasing the mouse button, a dialog box will appear. Enter the category name for the item, and click **OK**. For instance, **apple** for apples, **potato** for potatoes. Ensure that items of the same category have the same name.

<img src="../_static/media/chapter_10/section_1/media/image141.png"  style="width:600px"  class="common_img" />

10. Once the labeling is complete for one image, click **Save** to save the annotation, and then click **Next Image** to move on to the next image for labeling.

<img src="../_static/media/chapter_10/section_1/media/image142.png"  style="width:600px"  class="common_img" />
...
11. Click the terminal icon <img src="../_static/media/chapter_10/section_1/media/image29.png" /> in the system desktop to open a command-line window.

12. Enter the following command to open the file for editing:

```bash
vim ~/my_data/classes.names
```

13. Press the **i** key to enter edit mode and add the class names for the target recognition objects. When adding multiple class names, each class name should be placed on a new line. For multiple entries, press **Enter** to create a new line, and then proceed with listing the class names according to their respective categories.

<img src="../_static/media/chapter_10/section_1/media/image143.png"  style="width:600px"  class="common_img" />

**The class names here must match the labels used in the labelImg annotation tool exactly.**

14. After editing, press **Esc**, then type :wq to save and close the file.

<img src="../_static/media/chapter_10/section_1/media/image144.png"  style="width:600px"  class="common_img" />

15. Next, enter the command to convert the data format and press **Enter**:
...
2. Adjust the color thresholds in advance to correctly detect the yellow lines, preventing misdetection during the lesson. For guidance on setting color thresholds, refer to the course [6. ROS+OpenCV Course](6_ROS+OpenCV课程.md#ROS+OpenCV-Course).
...
Power on the robot and connect it via the NoMachine remote control software. For detailed information, please refer to the section [7.2.1 Connecting via NoMachine](1.ROSOrin使用手册.md#Connecting-via-NoMachine) in the user manual.
...
The image callback function is used to read data from the camera node.
...
```python
    def __call__(self, image, result_image):
        # Centerline extraction based on weighted averaging
        centroid_sum = 0
        h, w = image.shape[:2]
        max_center_x = -1
        center_x = []
...
> [!NOTE]
> 
> * **Note: The following steps only enable turn sign detection in the camera feed and will not trigger the corresponding robot actions. To directly experience the autonomous driving feature, skip this lesson and refer to section 7.4.6 Comprehensive Application of Autonomous Driving in this document.**
> 
...
10. Enter the command to open the program:
    ...
    <img src="../_static/media/chapter_11/section_1/media/image25.png"  style="width:600px"  class="common_img" />
...
> [!NOTE]
> 
> * **The following steps only enable traffic light recognition in the camera feed and will not trigger the corresponding robot actions. To directly experience the autonomous driving feature, skip this lesson and refer to section 7.4.6 Comprehensive Application of Autonomous Driving in this document.**
> 
> * **The input command should be case sensitive, and the keywords can be complemented by the Tab key.**
...
> [!NOTE]
> 
> * **The following steps only enable turn sign detection in the camera feed and will not trigger the corresponding robot actions. To directly experience the autonomous driving feature, skip this lesson and refer to section 7.4.6 Comprehensive Application of Autonomous Driving in this document.**
> 
> * **The input command should be case sensitive, and the keywords can be complemented by the Tab key.**
...
<p id ="anther7.4.5.5"></p>

#### 7.4.5.5 Parameter Adjustment
...
4. Press the **i** key, locate the code in the red box, and adjust the parameters within it. Modifying these parameters controls where the robot starts the parking operation. Reducing the parameter value allows the robot to park closer to the crosswalk, while increasing the value makes the robot park further away from the crosswalk. After editing, press **Esc**, type the command `:wq`, and press **Enter** to save and exit.
...
<img src="../_static/media/chapter_11/section_1/media/image33.png"  style="width:600px"  class="common_img" />
...
Since lighting conditions affect color recognition, you need to adjust the thresholds for black, white, red, green, blue, and yellow before starting, following the instructions in the course [6. ROS + OpenCV Course](6_ROS+OpenCV课程.md#ROS+OpenCV-Course).
...
Adjust the color thresholds according to the actual lighting environment. For detailed instructions, refer to [6. ROS + OpenCV Course](6_ROS+OpenCV课程.md#ROS+OpenCV-Course).
