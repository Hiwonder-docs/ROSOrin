...
Set the recognition language via the desktop configuration tool. Double-click the Tool icon <img src="../_static/media/chapter_9/section_1/media/image15.png" style="width:50px" /> on the system desktop.
