...
For instructions on using the app, refer to the section [1.5.3 App Control]() in the user manual to view the related course.

For detailed information on connecting to a remote desktop, please refer to the section [1.7.2 AP Mode Connection Steps]() in the user manual.
...
For instructions on using the app, refer to Section [1.5 App Installation and Connection]() in the user manual to view the related course.

For detailed information on connecting to a remote desktop, please refer to Section [1.7.2 AP Mode Connection Steps]() in the user manual.
