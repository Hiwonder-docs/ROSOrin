...
2. Adjust the color thresholds in advance to correctly detect the yellow lines, preventing misdetection during the lesson. For guidance on setting color thresholds, refer to the course [6. ROS+OpenCV Course](6_ROS+OpenCV_Course.md#ROS+OpenCV-Course).
...
Power on the robot and connect it via the **NoMachine** remote control software. For detailed information, please refer to the section [7.2.1 Connecting via NoMachine](1_ROSOrin_User_Manual.md#Connecting-via-NoMachine) in the user manual.
...
Since lighting conditions affect color recognition, you need to adjust the thresholds for black, white, red, green, blue, and yellow before starting, following the instructions in [6. ROS + OpenCV Course](6_ROS+OpenCV_Course.md#ROS+OpenCV-Course).
...
Adjust the color thresholds according to the actual lighting environment. For detailed instructions, refer to [6. ROS + OpenCV Course](6_ROS+OpenCV_Course.md#ROS+OpenCV-Course).
